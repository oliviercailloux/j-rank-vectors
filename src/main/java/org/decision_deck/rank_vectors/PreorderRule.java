...
/**
 * A rule based on a preorder, a reflexive and transitive relation, not necessarily complete. If the relation is
 * complete, a {@link WeakOrderRule} is probably more appropriate.
 * 
