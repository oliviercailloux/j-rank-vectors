...
public class IncreasingRankVectorsUtils {
	...
	/**
	 * Retrieves a view of given rank-vectors where all rank-vectors are increasing.
	 * The returned collection has no connexion between voter and preferences.
	 * 
	 * @param rankVectors not <code>null</code>, may be empty.
