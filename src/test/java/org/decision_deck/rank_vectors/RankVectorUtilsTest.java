...
public class RankVectorUtilsTest {
	...
	final Set<List<Integer>> rankProfileBig = RankVectorsUtils.getRankProfile(ImmutableList.of(ord123, ord123,
		ord321, ord123, ord213));
	assertEquals(
		ImmutableSet.of(ImmutableList.of(1, 1, 3, 1, 2), ImmutableList.of(2, 2, 2, 2, 1),
	...
	final ImmutableList<Integer> longRv = ImmutableList.copyOf(ContiguousSet.create(Range.closed(1, 20),
