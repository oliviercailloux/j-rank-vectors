...
public class PreorderWithFitnessTest {
	...
	// @Test
	// public void testTr1() {
	// final PreorderWithFitness pr = new PreorderWithFitness(new AllRankVectors(1,
	// 1));
	...
	// final PreorderWithFitness pr = new PreorderWithFitness(all);
	// final Set<Pair<List<Integer>, List<Integer>>> paretoPairs =
	// all.getParetoDominanceNonTransitive().asPairs();
